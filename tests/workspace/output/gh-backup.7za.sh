...
7za a "${compression_options[@]}" "clappr-chromecast-captions-plugin.7z" "clappr-chromecast-captions-plugin"
...
7za a "${compression_options[@]}" "Android-Root-Script-Runner.7z" "Android-Root-Script-Runner"
...
7za a "${compression_options[@]}" "node-ibm-watson-language-translator.7z" "node-ibm-watson-language-translator"
...
7za a "${compression_options[@]}" "Android-PTT-Bluetooth-Speaker.7z" "Android-PTT-Bluetooth-Speaker"
rm -rf "Android-PTT-Bluetooth-Speaker"

git clone "${git_clone_options[@]}" "https://github.com/warren-bank/Android-libVLC-Demo.git"
7za a "${compression_options[@]}" "Android-libVLC-Demo.7z" "Android-libVLC-Demo"
rm -rf "Android-libVLC-Demo"

git clone "${git_clone_options[@]}" "https://github.com/warren-bank/Android-Broadcast-Mock-SMS.git"
7za a "${compression_options[@]}" "Android-Broadcast-Mock-SMS.7z" "Android-Broadcast-Mock-SMS"
...
7za a "${compression_options[@]}" "Android-Image-Slideshow-Screensaver.7z" "Android-Image-Slideshow-Screensaver"
...
7za a "${compression_options[@]}" "js-get-local-area-network-ip-address.7z" "js-get-local-area-network-ip-address"
rm -rf "js-get-local-area-network-ip-address"

git clone "${git_clone_options[@]}" "https://github.com/warren-bank/crx-Crackle.git"
7za a "${compression_options[@]}" "crx-Crackle.7z" "crx-Crackle"
rm -rf "crx-Crackle"

git clone "${git_clone_options[@]}" "https://github.com/warren-bank/node-hls-downloader-americastestkitchen.git"
7za a "${compression_options[@]}" "node-hls-downloader-americastestkitchen.7z" "node-hls-downloader-americastestkitchen"
...
7za a "${compression_options[@]}" "fork-Android-VideoExpertsGroup-RTSPPlayer.7z" "fork-Android-VideoExpertsGroup-RTSPPlayer"
...
7za a "${compression_options[@]}" "chrome-extension-to-zip-archive-converter.7z" "chrome-extension-to-zip-archive-converter"
...
7za a "${compression_options[@]}" "jquery-table-multi-row-selectable-drag-drop.7z" "jquery-table-multi-row-selectable-drag-drop"
